...
namespace Phone_Cash
{
    public partial class StartForm : Form
    {
        ...
        private void Select_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                string s0 = null, s1 = null, s2 = null, s3 = null, s4 = null, s5 = null, s7 = null;
                pb = (PhoneBox)((Button)sender).Tag;
                command.CommandText = $"SELECT * FROM phones WHERE phone='{pb.phone.Text}'";
                reader = command.ExecuteReader();
                if (reader.Read())
                {
                    ...
                    s7 = reader.GetString(7);
                }
                reader.Close();
                command.Cancel();
                connection.Close();
                Form1 f = new Form1(s0, s1, s2, s3, s4, s5, s7, System.IO.File.Exists("newFirst") && System.IO.File.ReadAllText("newFirst") == "1");
                f.ShowDialog();
